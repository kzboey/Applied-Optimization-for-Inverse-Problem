...
exp1, stopIdx = aomip.pogm(Afd,bfd_log,x0,aomip.proximalHuber,proxParams,mygrad=df,iteration=1000,callback=False)
...
exp2, stopIdx = aomip.pogm(Afd,bfd_log,x0,aomip.proximalL2Squared,proxParams,mygrad=df,iteration=1000,callback=False)
print('iteration :',stopIdx) 
exp2= exp2.reshape((512,512))
aomip.save_array_as_image(exp2,'exp2.png','img2')

# full dose reconstruction with OGM1 
exp3, stopIdx = aomip.compute_OGM1(Afd,bfd_log,x0,beta=1,regularizer='tikhonov',mygrad=df,iteration=1000,callback=False)
print('iteration :',stopIdx) 
exp3= exp3.reshape((512,512))
aomip.save_array_as_image(exp3,'exp3.png','img2')

# full dose reconstruction with bb2
exp4, stopIdx = aomip.bb_linesearch(Afd,bfd_log,x0,beta=1,bb=2,regularizer='tikhonov',mygrad=df,iteration=1000,callback=False)
print('iteration :',stopIdx) 
...
proxParams = {'v':x0, 'x':x0, 'beta':0.01, 'delta': 1 }
exp5, stopIdx = aomip.pogm(Aqd,bqd_log,x0,aomip.proximalHuber,proxParams,mygrad=df,iteration=1000,callback=False)
print('iteration :',stopIdx) 
...
# Quarter dose reconstruction with pogm
proxParams = {'v':x0, 'x':x0, 'beta':1}
exp6, stopIdx = aomip.pogm(Aqd,bqd_log,x0,aomip.proximalL2Squared,proxParams,mygrad=df,iteration=1000,callback=False)
print('iteration :',stopIdx) 
exp6= exp6.reshape((512,512))
aomip.save_array_as_image(exp6,'exp6.png','img2')

# Quarter dose reconstruction with OGM1 
exp7, stopIdx = aomip.compute_OGM1(Aqd,bqd_log,x0,beta=1,regularizer='tikhonov',mygrad=df,iteration=1000,callback=False)
print('iteration :',stopIdx) 
exp7= exp7.reshape((512,512))
aomip.save_array_as_image(exp7,'exp7.png','img2')

# Quarter dose reconstruction with bb2
exp8, stopIdx = aomip.bb_linesearch(Aqd,bqd_log,x0,beta=1,bb=2,regularizer='tikhonov',mygrad=df,iteration=1000,callback=False)
print('iteration :',stopIdx) 
...
# full dose reconstruction with pogm
proxParams = {'v':x0, 'x':x0, 'beta':1, 'delta': 1 }
exp9, stopIdx = aomip.pogm(Afd,bfd,x0,aomip.proximalHuber,proxParams,iteration=1000,callback=False)
print('iteration :',stopIdx) 
exp9= exp9.reshape((512,512))
aomip.save_array_as_image(exp9,'exp9.png','img2')

# full dose reconstruction with bb2
exp10, stopIdx = aomip.bb_linesearch(Afd,bfd,x0,beta=1,bb=2,regularizer='tikhonov',iteration=1000,callback=False)
print('iteration :',stopIdx) 
...
# Quarter dose reconstruction with pogm
proxParams = {'v':x0, 'x':x0, 'beta':1, 'delta': 1 }
exp11, stopIdx = aomip.pogm(Aqd,bqd,x0,aomip.proximalHuber,proxParams,iteration=1000,callback=False)
print('iteration :',stopIdx) 
...
# Quarter dose reconstruction with pogm
proxParams = {'v':x0, 'x':x0, 'beta':1}
exp12, stopIdx = aomip.pogm(Aqd,bqd,x0,aomip.proximalL2Squared,proxParams,iteration=1000,callback=False)
print('iteration :',stopIdx) 
exp12= exp12.reshape((512,512))
aomip.save_array_as_image(exp12,'exp12.png','img2')

# Quarter dose reconstruction with bb2
exp13, stopIdx = aomip.bb_linesearch(Aqd,bqd,x0,beta=1,bb=2,regularizer='tikhonov',iteration=1000,callback=False)
print('iteration :',stopIdx) 
